    ...
    <div class="modal-dialog">
        <div class="modal-content" style="background-color: #E1F5FE ;color:black ; font-size: 15px; font-family:Times" >
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-default btn-curve pull-left" style='background-color:  #E1F5FE  ;color:black ; font-size: 12px; font-family:Times' data-dismiss="modal"><i class="fa fa-close"></i> Close</button>
            </div>
        </div>
    </div>
</div>
