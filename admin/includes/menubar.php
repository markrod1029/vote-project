<aside class="main-sidebar "style="background-color: #E1F5FE ">
  <!-- sidebar: style can be found in sidebar.less -->
  <section class="sidebar" style="background-color: #E1F5FE">
    <!-- Sidebar user panel -->
    ...
    <ul class="sidebar-menu" data-widget="tree" style="background-color: #6c6977 ; color:white ; font-size: 15px; font-family:Times  " >
