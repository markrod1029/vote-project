...
<div class="login-box" style="background-color: #FFF; color: #333; padding: 30px; border-radius: 8px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); width: 360px;">
    <div class="login-logo" style="margin-bottom: 20px;">
        <b style="color: #0288D1; font-size: 24px;">Online Voting System</b>
    </div>
  
    <div class="login-box-body">
        <p class="login-box-msg" style="color: #666; font-size: 16px; margin-bottom: 20px;">Sign in to start your admin session</p>

        <form action="login.php" method="POST">
            <div class="form-group has-feedback" style="margin-bottom: 20px;">
                <input type="text" class="form-control" name="username" placeholder="Username" required style="padding: 10px; border-radius: 4px; border: 1px solid #CCC; width: 100%;">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <button type="submit" class="btn btn-primary btn-block" style="background-color: #0288D1; color: #FFF; padding: 10px; border: none; border-radius: 4px; font-size: 16px;" name="login"><i class="fa fa-sign-in"></i> Sign In</button>
                </div>
            </div>
        </form>
    </div>
